class AudioController {
    constructor() {
        this.bgMusic = new Audio('Assets/Audio/Assets_Audio_creepy (1).mp3');
...
class MixOrMatch {
    constructor(totalTime, cards) {
        ...
        this.timer = document.getElementsByClassName('time-remaining');
        this.ticker = document.getElementsByClassName('flips');
    ...
    startCountDown() {
        return setInterval(() => {
            this.timeRemaining--;
            this.timer.innerText = this.timeRemaining;
            console.log(this.timer.innerText);
    ...
    flipCard(card) {
        if (this.canFlipCard(card)) {
            ...
            this.totalClicks++;
            this.ticker.innerText = this.totalClicks;
            console.log("flips",this.ticker.innerText);
